...
Use this to orient yourself before diving into the task. If your task touches files that have already been modified, read those files first — they contain the latest state of the implementation.
